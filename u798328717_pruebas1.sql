...
-- Tiempo de generación: 04-03-2026 a las 03:28:12
...
CREATE TABLE `tickets` (
  ...
  `t_equip` varchar(100) NOT NULL,
  `t_resolucion` text CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish_ci DEFAULT NULL,
...
CREATE TABLE `ticket_historial` (
  ...
  `emp_id` int(11) NOT NULL,
  `th_accion` varchar(255) NOT NULL,
  `th_detalles` text DEFAULT NULL,
  `th_crea` datetime NOT NULL
...
INSERT INTO `ticket_historial` (`th_id`, `tick_id`, `emp_id`, `th_accion`, `th_detalles`, `th_crea`) VALUES
(1, 1, 1, 'Nota Interna Agregada', 'Se agregó una nota privada de soporte.', '2026-03-03 11:29:50'),
(2, 1, 1, 'Actualización de Ticket', 'Se modificaron los parámetros del ticket.', '2026-03-03 11:30:43'),
(3, 1, 1, 'Ticket marcado como Resuelto', 'El técnico ha aplicado una solución al ticket.', '2026-03-03 11:35:06');
...
INSERT INTO `ticket_mensajes` (`td_id`, `tick_id`, `emp_id`, `td_desc`, `td_data`, `td_crea`, `td_stat`) VALUES
...
(23, 1, 1, '<p>El ticket ha sido marcado como resuelto bajo el siguiente motivo:</p><br><p><em>\"Se marca el ticket como resuelto para verificar funcionamiento de la pestaña resolución\"</em></p>', NULL, '2026-03-03 11:35:07', 1);
...
CREATE TABLE `ticket_notas` (
  ...
  `tick_id` int(11) NOT NULL,
  `emp_id` int(11) NOT NULL,
  `tn_desc` mediumtext DEFAULT NULL,
  `tn_crea` datetime NOT NULL,
  `tn_stat` int(11) NOT NULL DEFAULT 1
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_spanish_ci;

--
-- Volcado de datos para la tabla `ticket_notas`
--

INSERT INTO `ticket_notas` (`tn_id`, `tick_id`, `emp_id`, `tn_desc`, `tn_crea`, `tn_stat`) VALUES
(1, 1, 1, 'Esta es una nota de prueba.', '2026-03-03 11:29:49', 1);
...
--
ALTER TABLE `ticket_mensajes`
  MODIFY `td_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;

--
-- AUTO_INCREMENT de la tabla `ticket_notas`
--
ALTER TABLE `ticket_notas`
  MODIFY `tn_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `ticket_mensajes`
  ADD CONSTRAINT `ticket_mensajes_ibfk_1` FOREIGN KEY (`tick_id`) REFERENCES `tickets` (`t_id`),
  ADD CONSTRAINT `ticket_mensajes_ibfk_2` FOREIGN KEY (`emp_id`) REFERENCES `empleados` (`e_id`);

DELIMITER $$
--
-- Eventos
--
CREATE DEFINER=`u798328717_Skull`@`%` EVENT `cerrar_tickets_resueltos` ON SCHEDULE EVERY 1 DAY STARTS '2026-03-02 09:33:15' ON COMPLETION NOT PRESERVE ENABLE DO UPDATE tickets 
  SET est_id = 6, 
      sest_id = 14, -- Ticket Resuelto (Subestatus)
      t_upd = NOW()
  WHERE est_id = 5 
